<?php
require_once 'config/database.php'; // Assurez-vous que ce fichier contient une connexion sécurisée à la base de données
                            ...
                            <tbody>
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="user-avatar me-3"><?= strtoupper(substr($user['full_name'], 0, 2)) ?></div>
                                                <div>
                                                    <strong><?= htmlspecialchars($user['full_name']) ?></strong>
                                                    <br>
                                                    <small class="text-muted"><?= htmlspecialchars($user['role_user']) ?></small>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?= htmlspecialchars($user['email_user']) ?></td>
                                        <td>
                                            <span class="badge bg-primary"><?= htmlspecialchars($user['role_user']) ?></span>
                                        </td>
