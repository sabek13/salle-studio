...
<body>
            ...
            ?>
                <div class="tab-pane show active" id="blog">
                    ...
                    <div class="header-card d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h2 class="mb-2 section-title"><i class="fas fa-blog me-2"></i>Gestion du Blog</h2>
                                        ...
                                        ?><tr>
                                            <td>
                                                ...
                                                <?php if (!empty($imagePath)): ?>
                                                    <img width="50" src="http://localhost/studio/<?= htmlspecialchars($imagePath) ?>" class="article-thumb" alt="Miniature">
                                                <?php endif; ?>
                                            </td>
                ...
                <!-- Modal de modification d'article (à compléter si besoin) -->
                <!-- Modal de suppression d'article (à compléter si besoin) -->
    ...
    <!-- Modal de modification d'utilsateur
            <div class="modal fade" id="editUserModal" tabindex="-1">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
